...
int main()
{
  ...
  // TODO: Initialize the pid variable.
    ...
    if (!init_flag) {
        pid_steer.Init(0.224, 0.00045, 4.5, 1, 1, 1);
        pid_throttle.Init(0.2, 0, 0, 0, 0, 0);
        init_flag = true;
    }
//    total_iters = 0;
...
//          if (pid.AccErrorCalculation() > 1) {

//            if (fabs(cte) > 2.5 || (speed < 5.0 && total_iters > 300)) {
//            if (total_iters > 5000){
//                cout << "cte: " << cte << endl;
//                cout << "Twiddling!!" << endl;
...
//                ResetSimulator(ws);
//                pid.ResetError();
//                cout << "params:" << pid.params[0] << " " << pid.params[1] << " " << pid.params[2] << endl;
//                cout << "d_params:" << pid.d_params[0] << " " << pid.d_params[1] << " " << pid.d_params[2] << endl;
//                total_iters = 0;
//            }
//          }
